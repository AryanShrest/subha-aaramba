  ...
  return (
    <div className="min-h-screen bg-background p-4 sm:p-8">
      <div className="mx-auto max-w-4xl">
        ...
        {/* Add Service Form */}
        <form onSubmit={handleAdd} className="mb-12 space-y-4 rounded-2xl border border-border bg-card p-6 shadow">
              ...
              {editId === s.id ? (
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    <img src={editImageFile ? URL.createObjectURL(editImageFile) : s.image_url} alt={s.title} className="h-16 w-24 rounded-lg object-cover" />
                  ...
                  <div className="flex gap-2">
                    ...
                    <button onClick={() => { setEditId(null); setEditForm({}); }} className="flex items-center gap-1 rounded-lg border border-border px-4 py-2 text-sm font-semibold hover:bg-muted">
                      <X size={15} /> Cancel
                    </button>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex gap-2">
                    <button onClick={() => startEdit(s)} className="rounded-lg p-2 text-[var(--brand)] hover:bg-[var(--brand)]/10">
                      <Pencil size={18} />
                    </button>
